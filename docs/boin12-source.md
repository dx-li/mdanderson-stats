...
Beta(1,1) prior. The default utility order is
...
the explicitly supplied toxicity target. It compares posterior utility
...
the toxicity limit as the MTD, and maximizes posterior mean utility among
admissible doses at or below that MTD.

Late-onset outcomes, pending-data weighting, rank-desirability lookup tables,
and multilevel endpoints are not inferred here; they require their separate
BOIN12/TITE-BOIN12 specifications.
