...
Thirty-three of the 35 F95 mathematical procedures are implemented. `bfrac` and
`bratio`, other CDFLIB support interfaces and the remaining software catalog still
require work. CDFLIB90 remains partial.
