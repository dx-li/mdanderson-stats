...
The later [bgrat port](cdflib-bgrat.md) brings coverage to 32 of the 35 F95
mathematical procedures. `basym`, `bfrac` and `bratio`, other support interfaces, and the remaining software catalog
