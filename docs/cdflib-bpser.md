...
Thirty-one of the 35 F95 mathematical procedures are implemented. `basym`, `bfrac`,
`bgrat` and `bratio`, other support interfaces, and the remaining software catalog
