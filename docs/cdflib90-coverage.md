...
endpoint/status contracts, inaccurate results and five timeouts. The [bgrat port](cdflib-bgrat.md) is implemented; basym, bfrac and bratio
remain pending.
