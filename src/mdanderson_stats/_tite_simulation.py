"""Shared potential-outcome generation and calendar simulation aggregation."""
...
from ._tite_calendar import CalendarTrial
...
def simulate_calendar[S](
    replay: Callable[[FloatArray, FloatArray, float, int, int], CalendarTrial[S]],
    ...
    for trial in range(repetitions):
        ...
        result = replay(gaps, delays, duration, size, start)
