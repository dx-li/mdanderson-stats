...
from .cdflib_f import _coordinate, cdf_f, inv_f
...
def _tails(
    ...
    result = cdf_f(f=f[central], dfn=dfn[central], dfd=dfd[central])
    p[central], q[central] = result.cum, result.ccum
    active = ~central
...
def _verify(
    p: FloatArray, q: FloatArray, f: FloatArray, dfn: FloatArray, dfd: FloatArray, nc: FloatArray
) -> None:
...
def _invert_noncentrality(
    p: FloatArray, q: FloatArray, f: FloatArray, dfn: FloatArray, dfd: FloatArray
) -> FloatArray:
